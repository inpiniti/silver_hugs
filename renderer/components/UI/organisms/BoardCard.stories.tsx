...
export const Notice = () => <BoardCard icon={"notice"} title={'게시판'} rows={rows} />
export const Event = () => <BoardCard icon={"event"} title={'구인구직 / 행사'} rows={rows} />
export const Schedule = () => <BoardCard icon={"schedule"} title={'LIVE 일정보기'} rows={rows} />